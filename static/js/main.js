...
var $author$project$Main$Model = F3(
	function (env, varString, error) {
		return {env: env, error: error, varString: varString};
	});
var $author$project$C$Env$Env = F4(
	function (types, addrs, store, nextAddr) {
		return {addrs: addrs, nextAddr: nextAddr, store: store, types: types};
	});
var $elm$core$Dict$RBEmpty_elm_builtin = {$: 'RBEmpty_elm_builtin'};
var $elm$core$Dict$empty = $elm$core$Dict$RBEmpty_elm_builtin;
var $author$project$C$Env$emptyEnv = A4($author$project$C$Env$Env, $elm$core$Dict$empty, $elm$core$Dict$empty, $elm$core$Dict$empty, 0);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A3($author$project$Main$Model, $author$project$C$Env$emptyEnv, '', ''),
...
var $author$project$Parser$Extra$problemToString = function (p) {
	switch (p.$) {
		case 'Expecting':
			var s = p.a;
			return 'expecting \'' + (s + '\'');
...
var $author$project$Parser$Extra$deadEndToString = function (deadend) {
	return $author$project$Parser$Extra$problemToString(deadend.problem) + (' at row ' + ($elm$core$String$fromInt(deadend.row) + (', col ' + $elm$core$String$fromInt(deadend.col))));
};
...
var $author$project$Parser$Extra$deadEndsToString = function (deadEnds) {
...
var $author$project$C$Exp$Deref = function (a) {
	return {$: 'Deref', a: a};
};
var $author$project$C$Exp$Lit = function (a) {
	return {$: 'Lit', a: a};
};
var $author$project$C$Exp$Null = {$: 'Null'};
var $author$project$C$Exp$Var = function (a) {
	return {$: 'Var', a: a};
};
...
var $author$project$C$Parse$parseVarName = $elm$parser$Parser$variable(
	{
		inner: function (c) {
			return $elm$core$Char$isAlphaNum(c) || _Utils_eq(
				c,
...
var $author$project$C$Parse$parseExp = function (env) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2($elm$parser$Parser$map, $author$project$C$Exp$Lit, $elm$parser$Parser$int),
				A2(
				$elm$parser$Parser$map,
				$elm$core$Basics$always($author$project$C$Exp$Null),
				$elm$parser$Parser$keyword('null')),
				A2(
				$elm$parser$Parser$keeper,
				A2(
					$elm$parser$Parser$ignorer,
					$elm$parser$Parser$succeed($author$project$C$Exp$Addr),
				...
				A2(
					$elm$parser$Parser$ignorer,
					$elm$parser$Parser$succeed($author$project$C$Exp$Deref),
					$elm$parser$Parser$symbol('*')),
			...
			[
				...
				$elm$parser$Parser$succeed(
					$elm$parser$Parser$Loop(
						A2($elm$core$Basics$composeL, $author$project$C$Type$PointerT, appPointerT))),
				$elm$parser$Parser$symbol('*')),
				$elm$parser$Parser$succeed(
				$elm$parser$Parser$Done(appPointerT))
			]));
};
...
var $author$project$C$Parse$parseType = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
...
var $author$project$C$Type$view = function (t) {
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('C definition:')
							])),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$placeholder('int x = 0;'),
								$elm$html$Html$Attributes$value(model.varString),
								$elm$html$Html$Events$onInput($author$project$Main$ChangeCVarInput),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$AddVar),
								$elm$html$Html$Attributes$type_('button')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Add variable')
							]))
					])),
				A2(
				$elm$html$Html$aside,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Current variable environment')
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$author$project$C$Env$view(model.env)
							]))
					]))
			]));
};
